"""
Django settings for empty_union_46952 project.
...
ROOT_URLCONF = 'empty_union_46952.urls'
...
WSGI_APPLICATION = 'empty_union_46952.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_union_46952 API",
    "DESCRIPTION": "API documentation for empty_union_46952 App",
    "VERSION": "v1",
}
